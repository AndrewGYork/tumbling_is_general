...
out_dir = cwd.parents[3] / 'tumbling_temp' / 'camera_fantasyFP_higherN'
...
results = pd.read_csv('01_pump_probe_n1p0e+06_tqy0p5_9reps_2pulses.csv')
mixed_list = []
...
for i in range(120):
    ...
    ax2.set_yticks(np.linspace(1e4, 6e4, 6))
    ax2.set_ylim(1e4, 6e4)
