...
to_save.to_csv('mVenus_40nmbead_traces.csv')
...
plt.title('mVenus, 40 nm beads')
plt.savefig('mVenus_40nmbeads_overlaid.png', bbox_inches='tight')
...
fig6.axes[0].set_title('mVenus, 40 nm beads')
fig6.axes[0].legend()
plt.savefig('mVenus_40nmbeads_fits.png', bbox_inches='tight')
