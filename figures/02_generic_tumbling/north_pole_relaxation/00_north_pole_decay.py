...
# This script simulates how a population artificially started at the
# north pole would relax over time. Because we are orienting the
# molecules initially, we simply track the orientation of the ground
# state molecules for the duration of the simulation (i.e. no excited
# states involved).
